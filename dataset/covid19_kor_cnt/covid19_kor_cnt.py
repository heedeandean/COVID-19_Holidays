...
html = urlopen(
    "http://ncov.mohw.go.kr/bdBoardList_Real.do?brdId=1&brdGubun=13&ncvContSeq=&contSeq=&board_id=&gubun=")  # 전국
html_kk = urlopen(
    "https://www.gg.go.kr/contents/contents.do?ciIdx=1150&menuId=2909")  # 경기도
